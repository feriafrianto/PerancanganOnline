@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/DashboardImage.jpg);" data-aos="fade">
    <div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2">Cari Kebutuhan Rumah Tangga Kamu Di Sini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Toko segala kebutuhan rumah tangga yang anda butuhkan tersedia disini</p>
            <p>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            ...
            <p>Kualitas barangnya terjamin.</p>
        </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="nonloop-block-3 owl-carousel" >
            ...
            <div class="block-4 text-center">
                ...
                <a href="{{ route('user.produk.detail',['id' =>  $produk->id]) }}" class="btn btn-primary mt-2">Lihat Detail</a>
                </div>
            </div>
            </div>
            @endforeach
