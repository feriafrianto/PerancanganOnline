...
<div class="bg-light py-3">
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Status Order</strong></div>
        </div>
    </div>
</div>
...
<div class="site-section">
    ...
    <div class="container">
        <div class="row mb-3">
            <div class="col-md-12">
                <h2 class="btn btn-info text-white">Sedang Dalam Proses</h2>
            </div>
        </div>
        <div class="row mb-5">
            <div class="col-md-12">
